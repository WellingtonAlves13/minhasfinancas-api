package com.asxdev.minhasfinancas.api.resource;
...
import com.asxdev.minhasfinancas.api.dto.AtualizaStatusDTO;
import com.asxdev.minhasfinancas.api.dto.LancamentoDTO;
...
import com.asxdev.minhasfinancas.model.enums.TipoLancamento;
import com.asxdev.minhasfinancas.service.LancamentoService;
import com.asxdev.minhasfinancas.service.UsuarioService;
...
public class LancamentoResource {
	...
	private Lancamento converter(LancamentoDTO dto) {
		...
		Usuario usuario = usuarioService.obterPorId(dto.getUsuario())
				.orElseThrow(() -> new RegraNegocioException("DDDD"));
